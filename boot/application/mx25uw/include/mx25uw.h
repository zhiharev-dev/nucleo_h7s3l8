...
/* Структура данных MX25UW */
typedef struct
{
    xspi_handle_t * xspi;   /* Указатель на обработчик XSPI */
} mx25uw_t;

/* Exported variables ------------------------------------------------------ */

extern mx25uw_t mx25uw;
